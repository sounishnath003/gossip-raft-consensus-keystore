...
const file_proto_kv_proto_rawDesc = "" +
	...
	"\fgrpc_address\x18\x03 \x01(\tR\vgrpcAddress\"\x0e\n" +
	"\fJoinResponse\"\x80\x01\n" +
	"\rGossipRequest\x125\n" +
	"\x05state\x18\x01 \x03(\v2\x1f.proto.GossipRequest.StateEntryR\x05state\x1a8\n" +
	"\n" +
	"StateEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\x10\n" +
	"\x0eGossipResponse2\xc8\x01\n" +
	"\x02KV\x12,\n" +
	...
	"\x04Join\x12\x12.proto.JoinRequest\x1a\x13.proto.JoinResponse\x125\n" +
	"\x06Gossip\x12\x14.proto.GossipRequest\x1a\x15.proto.GossipResponseB\x1dZ\x1bdistirbuted-key-store/protob\x06proto3"
